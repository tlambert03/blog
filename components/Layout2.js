...
export default function Layout({ children }) {
  return (
    <div className="absolute h-full w-60 bg-white shadow-md" id="sidenavSecExample">
      ...
      <ul className="relative px-1">
        <li className="relative">
          <a
            className="flex h-12 items-center overflow-hidden text-ellipsis whitespace-nowrap rounded py-4 px-6 text-sm text-gray-700 transition duration-300 ease-in-out hover:bg-blue-50 hover:text-blue-600"
            href="#!"
        ...
        <li className="relative" id="sidenavSecEx2">
          <a
            className="flex h-12 cursor-pointer items-center overflow-hidden text-ellipsis whitespace-nowrap rounded py-4 px-6 text-sm text-gray-700 transition duration-300 ease-in-out hover:bg-blue-50 hover:text-blue-600"
            data-mdb-ripple="true"
            data-mdb-ripple-color="primary"
          ...
          >
            <li className="relative">
              <a
                href="#!"
                className="flex h-6 items-center overflow-hidden text-ellipsis whitespace-nowrap rounded py-4 pl-12 pr-6 text-xs text-gray-700 transition duration-300 ease-in-out hover:bg-blue-50 hover:text-blue-600"
                data-mdb-ripple="true"
                data-mdb-ripple-color="primary"
              >
                Link 1
